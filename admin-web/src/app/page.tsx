  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFC] text-slate-900 font-sans">
          ...
          <nav className="p-4 space-y-2">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm">Tenants (Facilities)</div>
                  <div className="text-[11px] text-slate-400 font-normal">
                    Facilities & UPI payouts
                  </div>
                </div>
              </div>
              <span className="text-xs px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 font-medium">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm">Subscription Plans</div>
                  <div className="text-[11px] text-slate-400 font-normal">
                    Store & credit quotas
                  </div>
                </div>
      ...
      <main className="ml-72 flex-1 p-8 min-h-screen">
          ...
          <div className="space-y-8 animate-in fade-in duration-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
                ...
                <div className="text-2xl font-bold text-slate-900">{members.length}</div>
                <div className="text-xs text-slate-500 mt-1">Managed across tenants</div>
              </div>
        ...
        {/* ────────────────────────────────────────────────────────────────────────
            TAB 3: SUBSCRIPTION PLANS STORE & PACKAGES
        ──────────────────────────────────────────────────────────────────────── */}
        {activeTab === "plans" && (
          <div className="space-y-8 animate-in fade-in duration-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
                ...
                <div className="text-2xl font-bold text-emerald-600">
                  {appPlans.filter((p) => p.isActive).length}
                </div>
                <div className="text-xs text-slate-500 mt-1">Available for subscription</div>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
                ...
                <div className="text-2xl font-bold text-slate-900">
                  {appPlans.filter((p) => p.isFreeTrial).length}
                </div>
                <div className="text-xs text-slate-500 mt-1">Introductory trial plans</div>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
                ...
                <div className="text-xs text-slate-500 mt-1">Active facility users</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-4 border-b border-slate-100">
                <div>
                  <h3 className="text-lg font-bold text-slate-900 tracking-tight">
                    Facility Subscription Packages
                  </h3>
                  <p className="text-xs text-slate-500">
                    Pricing tiers for mobile app users (tenants). Each subscription plan includes compulsory WhatsApp credits.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {appPlans.map((plan) => (
                  <div
                    key={plan.id}
                    className="bg-slate-50/50 rounded-2xl border border-slate-200 p-6 shadow-xs flex flex-col justify-between relative hover:bg-white hover:border-slate-300 hover:shadow-sm transition"
                  >
                    {plan.tag && (
                      <span className="absolute top-5 right-5 text-[10px] uppercase font-extrabold px-2.5 py-1 rounded-full bg-blue-100 text-blue-700 border border-blue-200">
                        {plan.tag}
                      </span>
                    )}
                    ...
                    <div>
                      ...
                      <div className="my-5 pb-5 border-b border-slate-200/70">
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-200/70 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-white hover:bg-slate-100 text-slate-700 border border-slate-200 rounded-lg transition"
                        title="Edit Plan"
                      >
